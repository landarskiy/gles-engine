/* !---- DO NOT EDIT: This file autogenerated by com/jogamp/gluegen/opengl/GLEmitter.java on Tue Mar 11 04:17:45 CET 2014 ----! */
...
public interface GL2 extends GL2ES1, GL2GL3{
  ...
  /** Part of <code>GL_EXT_texture_storage</code>; <code>GL_ARB_texture_float</code> */
  ...
  /** Part of <code>GL_AMD_interleaved_elements</code> */
  ...
  /** Part of <code>GL_AMD_query_buffer_object</code> */
  ...
  /** Part of <code>GL_AMD_sparse_texture</code> */
  ...
  /** Part of <code>GL_APPLE_vertex_array_range</code>, <code>GL_APPLE_texture_range</code> */
  ...
  /** Part of <code>GL_EXT_timer_query</code>, <code>GL_EXT_disjoint_timer_query</code> */
  ...
  /** Part of <code>GL_INTEL_map_texture</code> */
  ...
  /** Part of <code>GL_NV_compute_program5</code> */
  ...
  /** Part of <code>GL_NV_deep_texture3D</code> */
  ...
  /** Part of <code>GL_NV_path_rendering</code> */
  ...
  /** Entry point to C language function: <code> void {@native glBeginConditionalRenderNVX}(GLuint id); </code> <br>Part of <code>GL_NVX_conditional_render</code>   */
  ...
  /** Entry point to C language function: <code> void {@native glBufferParameteri}(GLenum target, GLenum pname, GLint param); </code> <br>Part of <code>GL_APPLE_flush_buffer_range</code>   */
  ...
  /** Entry point to C language function: <code> void {@native glClearColorIi}(GLint red, GLint green, GLint blue, GLint alpha); </code> <br>Part of <code>GL_EXT_texture_integer</code>   */
  public void glClearColorIi(int red, int green, int blue, int alpha);

  /** Entry point to C language function: <code> void {@native glClearColorIui}(GLuint red, GLuint green, GLuint blue, GLuint alpha); </code> <br>Part of <code>GL_EXT_texture_integer</code>   */
  ...
  /** Entry point to C language function: <code> void {@native glClipPlanef}(GLenum plane, const GLfloat *  equation); </code> <br>Part of <code>GL_VERSION_ES_CM</code>; <code>GL_OES_single_precision</code>
  ...
  /** Entry point to C language function: <code> void {@native glColor3h}(GLhalfNV red, GLhalfNV green, GLhalfNV blue); </code> <br>Part of <code>GL_NV_half_float</code>   */
  public void glColor3h(short red, short green, short blue);

  /** Entry point to C language function: <code> void {@native glColor3hv}(const GLhalfNV *  v); </code> <br>Part of <code>GL_NV_half_float</code>
  ...
  /** Entry point to C language function: <code> void {@native glColor4h}(GLhalfNV red, GLhalfNV green, GLhalfNV blue, GLhalfNV alpha); </code> <br>Part of <code>GL_NV_half_float</code>   */
  public void glColor4h(short red, short green, short blue, short alpha);

  /** Entry point to C language function: <code> void {@native glColor4hv}(const GLhalfNV *  v); </code> <br>Part of <code>GL_NV_half_float</code>
      @param v a direct or array-backed {@link java.nio.ShortBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glColorMaskIndexed}(GLuint index, GLboolean r, GLboolean g, GLboolean b, GLboolean a); </code> <br>Part of <code>GL_EXT_draw_buffers2</code>   */
  ...
  /** Entry point to C language function: <code> void {@native glColorSubTable}(GLenum target, GLsizei start, GLsizei count, GLenum format, GLenum type, const GLvoid *  data); </code> <br>Part of <code>GL_VERSION_1_2</code>, <code>GL_ARB_imaging</code>
  ...
  /** Entry point to C language function: <code> void {@native glColorTable}(GLenum target, GLenum internalformat, GLsizei width, GLenum format, GLenum type, const GLvoid *  table); </code> <br>Part of <code>GL_VERSION_1_2</code>, <code>GL_ARB_imaging</code>
  ...
  /** Entry point to C language function: <code> void {@native glColorTableParameterfv}(GLenum target, GLenum pname, const GLfloat *  params); </code> <br>Part of <code>GL_VERSION_1_2</code>, <code>GL_ARB_imaging</code>
  ...
  /** Entry point to C language function: <code> void {@native glColorTableParameteriv}(GLenum target, GLenum pname, const GLint *  params); </code> <br>Part of <code>GL_VERSION_1_2</code>, <code>GL_ARB_imaging</code>
  ...
  /** Entry point to C language function: <code> void {@native glConvolutionFilter1D}(GLenum target, GLenum internalformat, GLsizei width, GLenum format, GLenum type, const GLvoid *  image); </code> <br>Part of <code>GL_VERSION_1_2</code>, <code>GL_ARB_imaging</code>
  ...
  /** Entry point to C language function: <code> void {@native glConvolutionFilter2D}(GLenum target, GLenum internalformat, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid *  image); </code> <br>Part of <code>GL_VERSION_1_2</code>, <code>GL_ARB_imaging</code>
      @param image a direct or array-backed {@link java.nio.Buffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glConvolutionParameterf}(GLenum target, GLenum pname, GLfloat params); </code> <br>Part of <code>GL_VERSION_1_2</code>, <code>GL_ARB_imaging</code>   */
  public void glConvolutionParameterf(int target, int pname, float params);

  /** Entry point to C language function: <code> void {@native glConvolutionParameterfv}(GLenum target, GLenum pname, const GLfloat *  params); </code> <br>Part of <code>GL_VERSION_1_2</code>, <code>GL_ARB_imaging</code>
      @param params a direct or array-backed {@link java.nio.FloatBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glConvolutionParameteri}(GLenum target, GLenum pname, GLint params); </code> <br>Part of <code>GL_VERSION_1_2</code>, <code>GL_ARB_imaging</code>   */
  public void glConvolutionParameteri(int target, int pname, int params);

  /** Entry point to C language function: <code> void {@native glConvolutionParameteriv}(GLenum target, GLenum pname, const GLint *  params); </code> <br>Part of <code>GL_VERSION_1_2</code>, <code>GL_ARB_imaging</code>
      @param params a direct or array-backed {@link java.nio.IntBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glCopyColorSubTable}(GLenum target, GLsizei start, GLint x, GLint y, GLsizei width); </code> <br>Part of <code>GL_VERSION_1_2</code>, <code>GL_ARB_imaging</code>   */
  public void glCopyColorSubTable(int target, int start, int x, int y, int width);

  /** Entry point to C language function: <code> void {@native glCopyColorTable}(GLenum target, GLenum internalformat, GLint x, GLint y, GLsizei width); </code> <br>Part of <code>GL_VERSION_1_2</code>, <code>GL_ARB_imaging</code>   */
  public void glCopyColorTable(int target, int internalformat, int x, int y, int width);

  /** Entry point to C language function: <code> void {@native glCopyConvolutionFilter1D}(GLenum target, GLenum internalformat, GLint x, GLint y, GLsizei width); </code> <br>Part of <code>GL_VERSION_1_2</code>, <code>GL_ARB_imaging</code>   */
  public void glCopyConvolutionFilter1D(int target, int internalformat, int x, int y, int width);

  /** Entry point to C language function: <code> void {@native glCopyConvolutionFilter2D}(GLenum target, GLenum internalformat, GLint x, GLint y, GLsizei width, GLsizei height); </code> <br>Part of <code>GL_VERSION_1_2</code>, <code>GL_ARB_imaging</code>   */
  ...
  /** Entry point to C language function: <code> void {@native glCopyPathNV}(GLuint resultPath, GLuint srcPath); </code> <br>Part of <code>GL_NV_path_rendering</code>   */
  ...
  /** Entry point to C language function: <code> void {@native glCoverFillPathInstancedNV}(GLsizei numPaths, GLenum pathNameType, const GLvoid *  paths, GLuint pathBase, GLenum coverMode, GLenum transformType, const GLfloat *  transformValues); </code> <br>Part of <code>GL_NV_path_rendering</code>
      @param paths a direct or array-backed {@link java.nio.Buffer}
      @param transformValues a direct or array-backed {@link java.nio.FloatBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glCoverFillPathNV}(GLuint path, GLenum coverMode); </code> <br>Part of <code>GL_NV_path_rendering</code>   */
  public void glCoverFillPathNV(int path, int coverMode);

  /** Entry point to C language function: <code> void {@native glCoverStrokePathInstancedNV}(GLsizei numPaths, GLenum pathNameType, const GLvoid *  paths, GLuint pathBase, GLenum coverMode, GLenum transformType, const GLfloat *  transformValues); </code> <br>Part of <code>GL_NV_path_rendering</code>
      @param paths a direct or array-backed {@link java.nio.Buffer}
      @param transformValues a direct or array-backed {@link java.nio.FloatBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glCoverStrokePathNV}(GLuint path, GLenum coverMode); </code> <br>Part of <code>GL_NV_path_rendering</code>   */
  ...
  /** Entry point to C language function: <code> void {@native glCurrentPaletteMatrix}(GLint index); </code> <br>Part of <code>GL_OES_matrix_palette</code>; <code>GL_ARB_matrix_palette</code>   */
  ...
  /** Entry point to C language function: <code> void {@native glDeletePathsNV}(GLuint path, GLsizei range); </code> <br>Part of <code>GL_NV_path_rendering</code>   */
  ...
  /** Entry point to C language function: <code> void {@native glDisableClientStateiEXT}(GLenum array, GLuint index); </code> <br>Part of <code>GL_EXT_direct_state_access</code>   */
  public void glDisableClientStateiEXT(int array, int index);

  /** Entry point to C language function: <code> void {@native glDisableIndexed}(GLenum target, GLuint index); </code> <br>Part of <code>GL_EXT_draw_buffers2</code>, <code>GL_EXT_direct_state_access</code>   */
  ...
  /** Entry point to C language function: <code> void {@native glDisableVertexArrayAttribEXT}(GLuint vaobj, GLuint index); </code> <br>Part of <code>GL_EXT_direct_state_access</code>   */
  public void glDisableVertexArrayAttribEXT(int vaobj, int index);

  /** Entry point to C language function: <code> void {@native glDisableVertexArrayEXT}(GLuint vaobj, GLenum array); </code> <br>Part of <code>GL_EXT_direct_state_access</code>   */
  ...
  /** Entry point to C language function: <code> void {@native glDrawTextureNV}(GLuint texture, GLuint sampler, GLfloat x0, GLfloat y0, GLfloat x1, GLfloat y1, GLfloat z, GLfloat s0, GLfloat t0, GLfloat s1, GLfloat t1); </code> <br>Part of <code>GL_NV_draw_texture</code>   */
  ...
  /** Entry point to C language function: <code> void {@native glEnableClientStateiEXT}(GLenum array, GLuint index); </code> <br>Part of <code>GL_EXT_direct_state_access</code>   */
  public void glEnableClientStateiEXT(int array, int index);

  /** Entry point to C language function: <code> void {@native glEnableIndexed}(GLenum target, GLuint index); </code> <br>Part of <code>GL_EXT_draw_buffers2</code>, <code>GL_EXT_direct_state_access</code>   */
  ...
  /** Entry point to C language function: <code> void {@native glEnableVertexArrayAttribEXT}(GLuint vaobj, GLuint index); </code> <br>Part of <code>GL_EXT_direct_state_access</code>   */
  public void glEnableVertexArrayAttribEXT(int vaobj, int index);

  /** Entry point to C language function: <code> void {@native glEnableVertexArrayEXT}(GLuint vaobj, GLenum array); </code> <br>Part of <code>GL_EXT_direct_state_access</code>   */
  ...
  /** Entry point to C language function: <code> void {@native glEndConditionalRenderNVX}(void); </code> <br>Part of <code>GL_NVX_conditional_render</code>   */
  ...
  /** Entry point to C language function: <code> void {@native glFogCoorddv}(const GLdouble *  coord); </code> <br>Part of <code>GL_VERSION_1_4</code>
  ...
  /** Entry point to C language function: <code> void {@native glFogCoordfv}(const GLfloat *  coord); </code> <br>Part of <code>GL_VERSION_1_4</code>
  ...
  /** Entry point to C language function: <code> void {@native glFogCoordh}(GLhalfNV fog); </code> <br>Part of <code>GL_NV_half_float</code>   */
  public void glFogCoordh(short fog);

  /** Entry point to C language function: <code> void {@native glFogCoordhv}(const GLhalfNV *  fog); </code> <br>Part of <code>GL_NV_half_float</code>
  ...
  /** Entry point to C language function: <code> GLuint {@native glGenPathsNV}(GLsizei range); </code> <br>Part of <code>GL_NV_path_rendering</code>   */
  ...
  /** Entry point to C language function: <code> void {@native glGetBooleanIndexedv}(GLenum target, GLuint index, GLboolean *  data); </code> <br>Part of <code>GL_EXT_draw_buffers2</code>, <code>GL_EXT_direct_state_access</code>
  ...
  /** Entry point to C language function: <code> void {@native glGetClipPlanef}(GLenum plane, GLfloat *  equation); </code> <br>Part of <code>GL_VERSION_ES_CM</code>; <code>GL_OES_single_precision</code>
      @param equation a direct or array-backed {@link java.nio.FloatBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glGetColorTable}(GLenum target, GLenum format, GLenum type, GLvoid *  table); </code> <br>Part of <code>GL_VERSION_1_2</code>, <code>GL_ARB_imaging</code>
      @param table a direct or array-backed {@link java.nio.Buffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glGetColorTableParameterfv}(GLenum target, GLenum pname, GLfloat *  params); </code> <br>Part of <code>GL_VERSION_1_2</code>, <code>GL_ARB_imaging</code>
      @param params a direct or array-backed {@link java.nio.FloatBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glGetColorTableParameteriv}(GLenum target, GLenum pname, GLint *  params); </code> <br>Part of <code>GL_VERSION_1_2</code>, <code>GL_ARB_imaging</code>
      @param params a direct or array-backed {@link java.nio.IntBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glGetConvolutionFilter}(GLenum target, GLenum format, GLenum type, GLvoid *  image); </code> <br>Part of <code>GL_VERSION_1_2</code>, <code>GL_ARB_imaging</code>
      @param image a direct or array-backed {@link java.nio.Buffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glGetConvolutionParameterfv}(GLenum target, GLenum pname, GLfloat *  params); </code> <br>Part of <code>GL_VERSION_1_2</code>, <code>GL_ARB_imaging</code>
      @param params a direct or array-backed {@link java.nio.FloatBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glGetConvolutionParameteriv}(GLenum target, GLenum pname, GLint *  params); </code> <br>Part of <code>GL_VERSION_1_2</code>, <code>GL_ARB_imaging</code>
      @param params a direct or array-backed {@link java.nio.IntBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glGetDoublei_vEXT}(GLenum pname, GLuint index, GLdouble *  params); </code> <br>Part of <code>GL_EXT_direct_state_access</code>
      @param params a direct or array-backed {@link java.nio.DoubleBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glGetFloati_vEXT}(GLenum pname, GLuint index, GLfloat *  params); </code> <br>Part of <code>GL_EXT_direct_state_access</code>
      @param params a direct or array-backed {@link java.nio.FloatBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glGetHistogram}(GLenum target, GLboolean reset, GLenum format, GLenum type, GLvoid *  values); </code> <br>Part of <code>GL_VERSION_1_2</code>, <code>GL_ARB_imaging</code>
  ...
  /** Entry point to C language function: <code> void {@native glGetHistogramParameterfv}(GLenum target, GLenum pname, GLfloat *  params); </code> <br>Part of <code>GL_VERSION_1_2</code>, <code>GL_ARB_imaging</code>
      @param params a direct or array-backed {@link java.nio.FloatBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glGetHistogramParameteriv}(GLenum target, GLenum pname, GLint *  params); </code> <br>Part of <code>GL_VERSION_1_2</code>, <code>GL_ARB_imaging</code>
      @param params a direct or array-backed {@link java.nio.IntBuffer}   */
  ...
  /** Entry point to C language function: <code> GLuint64 {@native glGetImageHandleNV}(GLuint texture, GLint level, GLboolean layered, GLint layer, GLenum format); </code> <br>Part of <code>GL_NV_bindless_texture</code>   */
  ...
  /** Entry point to C language function: <code> void {@native glGetIntegerIndexedv}(GLenum target, GLuint index, GLint *  data); </code> <br>Part of <code>GL_EXT_draw_buffers2</code>, <code>GL_EXT_direct_state_access</code>
  ...
  /** Entry point to C language function: <code> void {@native glGetMinmax}(GLenum target, GLboolean reset, GLenum format, GLenum type, GLvoid *  values); </code> <br>Part of <code>GL_VERSION_1_2</code>, <code>GL_ARB_imaging</code>
      @param values a direct or array-backed {@link java.nio.Buffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glGetMinmaxParameterfv}(GLenum target, GLenum pname, GLfloat *  params); </code> <br>Part of <code>GL_VERSION_1_2</code>, <code>GL_ARB_imaging</code>
      @param params a direct or array-backed {@link java.nio.FloatBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glGetMinmaxParameteriv}(GLenum target, GLenum pname, GLint *  params); </code> <br>Part of <code>GL_VERSION_1_2</code>, <code>GL_ARB_imaging</code>
      @param params a direct or array-backed {@link java.nio.IntBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glGetPathColorGenfvNV}(GLenum color, GLenum pname, GLfloat *  value); </code> <br>Part of <code>GL_NV_path_rendering</code>
  ...
  /** Entry point to C language function: <code> void {@native glGetPathColorGenivNV}(GLenum color, GLenum pname, GLint *  value); </code> <br>Part of <code>GL_NV_path_rendering</code>
  ...
  /** Entry point to C language function: <code> void {@native glGetPathCommandsNV}(GLuint path, GLubyte *  commands); </code> <br>Part of <code>GL_NV_path_rendering</code>
      @param commands a direct or array-backed {@link java.nio.ByteBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glGetPathCoordsNV}(GLuint path, GLfloat *  coords); </code> <br>Part of <code>GL_NV_path_rendering</code>
  ...
  /** Entry point to C language function: <code> void {@native glGetPathDashArrayNV}(GLuint path, GLfloat *  dashArray); </code> <br>Part of <code>GL_NV_path_rendering</code>
      @param dashArray a direct or array-backed {@link java.nio.FloatBuffer}   */
  ...
  /** Entry point to C language function: <code> GLfloat {@native glGetPathLengthNV}(GLuint path, GLsizei startSegment, GLsizei numSegments); </code> <br>Part of <code>GL_NV_path_rendering</code>   */
  public float glGetPathLengthNV(int path, int startSegment, int numSegments);

  /** Entry point to C language function: <code> void {@native glGetPathMetricRangeNV}(GLbitfield metricQueryMask, GLuint firstPathName, GLsizei numPaths, GLsizei stride, GLfloat *  metrics); </code> <br>Part of <code>GL_NV_path_rendering</code>
      @param metrics a direct or array-backed {@link java.nio.FloatBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glGetPathMetricsNV}(GLbitfield metricQueryMask, GLsizei numPaths, GLenum pathNameType, const GLvoid *  paths, GLuint pathBase, GLsizei stride, GLfloat *  metrics); </code> <br>Part of <code>GL_NV_path_rendering</code>
      @param paths a direct or array-backed {@link java.nio.Buffer}
      @param metrics a direct or array-backed {@link java.nio.FloatBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glGetPathParameterfvNV}(GLuint path, GLenum pname, GLfloat *  value); </code> <br>Part of <code>GL_NV_path_rendering</code>
      @param value a direct or array-backed {@link java.nio.FloatBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glGetPathParameterivNV}(GLuint path, GLenum pname, GLint *  value); </code> <br>Part of <code>GL_NV_path_rendering</code>
      @param value a direct or array-backed {@link java.nio.IntBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glGetPathSpacingNV}(GLenum pathListMode, GLsizei numPaths, GLenum pathNameType, const GLvoid *  paths, GLuint pathBase, GLfloat advanceScale, GLfloat kerningScale, GLenum transformType, GLfloat *  returnedSpacing); </code> <br>Part of <code>GL_NV_path_rendering</code>
      @param paths a direct or array-backed {@link java.nio.Buffer}
      @param returnedSpacing a direct or array-backed {@link java.nio.FloatBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glGetPathTexGenfvNV}(GLenum texCoordSet, GLenum pname, GLfloat *  value); </code> <br>Part of <code>GL_NV_path_rendering</code>
      @param value a direct or array-backed {@link java.nio.FloatBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glGetPathTexGenivNV}(GLenum texCoordSet, GLenum pname, GLint *  value); </code> <br>Part of <code>GL_NV_path_rendering</code>
      @param value a direct or array-backed {@link java.nio.IntBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glGetPixelTransformParameterfvEXT}(GLenum target, GLenum pname, GLfloat *  params); </code> <br>Part of <code>GL_EXT_pixel_transform</code>
      @param params a direct or array-backed {@link java.nio.FloatBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glGetPixelTransformParameterivEXT}(GLenum target, GLenum pname, GLint *  params); </code> <br>Part of <code>GL_EXT_pixel_transform</code>
      @param params a direct or array-backed {@link java.nio.IntBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glGetPointeri_vEXT}(GLenum pname, GLuint index, GLvoid *  *  params); </code> <br>Part of <code>GL_EXT_direct_state_access</code>
  ...
  /** Entry point to C language function: <code> void {@native glGetQueryObjecti64vEXT}(GLuint id, GLenum pname, GLint64EXT *  params); </code> <br>Part of <code>GL_EXT_timer_query</code>, <code>GL_EXT_disjoint_timer_query</code>
  ...
  /** Entry point to C language function: <code> void {@native glGetQueryObjectui64vEXT}(GLuint id, GLenum pname, GLuint64EXT *  params); </code> <br>Part of <code>GL_EXT_timer_query</code>, <code>GL_EXT_disjoint_timer_query</code>
      @param params a direct or array-backed {@link java.nio.LongBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glGetSeparableFilter}(GLenum target, GLenum format, GLenum type, GLvoid *  row, GLvoid *  column, GLvoid *  span); </code> <br>Part of <code>GL_VERSION_1_2</code>, <code>GL_ARB_imaging</code>
  ...
  /** Entry point to C language function: <code> GLuint64 {@native glGetTextureHandleNV}(GLuint texture); </code> <br>Part of <code>GL_NV_bindless_texture</code>   */
  ...
  /** Entry point to C language function: <code> GLuint64 {@native glGetTextureSamplerHandleNV}(GLuint texture, GLuint sampler); </code> <br>Part of <code>GL_NV_bindless_texture</code>   */
  ...
  /** Entry point to C language function: <code> void {@native glGetVertexArrayIntegeri_vEXT}(GLuint vaobj, GLuint index, GLenum pname, GLint *  param); </code> <br>Part of <code>GL_EXT_direct_state_access</code>
      @param param a direct or array-backed {@link java.nio.IntBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glGetVertexArrayIntegervEXT}(GLuint vaobj, GLenum pname, GLint *  param); </code> <br>Part of <code>GL_EXT_direct_state_access</code>
      @param param a direct or array-backed {@link java.nio.IntBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glGetVertexArrayPointeri_vEXT}(GLuint vaobj, GLuint index, GLenum pname, GLvoid *  *  param); </code> <br>Part of <code>GL_EXT_direct_state_access</code>
  ...
  /** Entry point to C language function: <code> void {@native glGetVertexArrayPointervEXT}(GLuint vaobj, GLenum pname, GLvoid *  *  param); </code> <br>Part of <code>GL_EXT_direct_state_access</code>
      @param param a direct or array-backed {@link com.jogamp.common.nio.PointerBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glGetnColorTable}(GLenum target, GLenum format, GLenum type, GLsizei bufSize, GLvoid *  table); </code> <br>Part of <code>GL_ARB_robustness</code>
      @param table a direct or array-backed {@link java.nio.Buffer}   */
  public void glGetnColorTable(int target, int format, int type, int bufSize, Buffer table);

  /** Entry point to C language function: <code> void {@native glGetnConvolutionFilter}(GLenum target, GLenum format, GLenum type, GLsizei bufSize, GLvoid *  image); </code> <br>Part of <code>GL_ARB_robustness</code>
      @param image a direct or array-backed {@link java.nio.Buffer}   */
  public void glGetnConvolutionFilter(int target, int format, int type, int bufSize, Buffer image);

  /** Entry point to C language function: <code> void {@native glGetnHistogram}(GLenum target, GLboolean reset, GLenum format, GLenum type, GLsizei bufSize, GLvoid *  values); </code> <br>Part of <code>GL_ARB_robustness</code>
      @param values a direct or array-backed {@link java.nio.Buffer}   */
  public void glGetnHistogram(int target, boolean reset, int format, int type, int bufSize, Buffer values);

  /** Entry point to C language function: <code> void {@native glGetnMapdv}(GLenum target, GLenum query, GLsizei bufSize, GLdouble *  v); </code> <br>Part of <code>GL_ARB_robustness</code>
      @param v a direct or array-backed {@link java.nio.DoubleBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glGetnMapfv}(GLenum target, GLenum query, GLsizei bufSize, GLfloat *  v); </code> <br>Part of <code>GL_ARB_robustness</code>
      @param v a direct or array-backed {@link java.nio.FloatBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glGetnMapiv}(GLenum target, GLenum query, GLsizei bufSize, GLint *  v); </code> <br>Part of <code>GL_ARB_robustness</code>
      @param v a direct or array-backed {@link java.nio.IntBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glGetnMinmax}(GLenum target, GLboolean reset, GLenum format, GLenum type, GLsizei bufSize, GLvoid *  values); </code> <br>Part of <code>GL_ARB_robustness</code>
      @param values a direct or array-backed {@link java.nio.Buffer}   */
  public void glGetnMinmax(int target, boolean reset, int format, int type, int bufSize, Buffer values);

  /** Entry point to C language function: <code> void {@native glGetnPixelMapfv}(GLenum map, GLsizei bufSize, GLfloat *  values); </code> <br>Part of <code>GL_ARB_robustness</code>
      @param values a direct or array-backed {@link java.nio.FloatBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glGetnPixelMapuiv}(GLenum map, GLsizei bufSize, GLuint *  values); </code> <br>Part of <code>GL_ARB_robustness</code>
      @param values a direct or array-backed {@link java.nio.IntBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glGetnPixelMapusv}(GLenum map, GLsizei bufSize, GLushort *  values); </code> <br>Part of <code>GL_ARB_robustness</code>
      @param values a direct or array-backed {@link java.nio.ShortBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glGetnPolygonStipple}(GLsizei bufSize, GLubyte *  pattern); </code> <br>Part of <code>GL_ARB_robustness</code>
  ...
  /** Entry point to C language function: <code> void {@native glGetnSeparableFilter}(GLenum target, GLenum format, GLenum type, GLsizei rowBufSize, GLvoid *  row, GLsizei columnBufSize, GLvoid *  column, GLvoid *  span); </code> <br>Part of <code>GL_ARB_robustness</code>
      @param row a direct or array-backed {@link java.nio.Buffer}
      @param column a direct or array-backed {@link java.nio.Buffer}
      @param span a direct or array-backed {@link java.nio.Buffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glHistogram}(GLenum target, GLsizei width, GLenum internalformat, GLboolean sink); </code> <br>Part of <code>GL_VERSION_1_2</code>, <code>GL_ARB_imaging</code>   */
  ...
  /** Entry point to C language function: <code> void {@native glInterpolatePathsNV}(GLuint resultPath, GLuint pathA, GLuint pathB, GLfloat weight); </code> <br>Part of <code>GL_NV_path_rendering</code>   */
  public void glInterpolatePathsNV(int resultPath, int pathA, int pathB, float weight);

  /** Entry point to C language function: <code> GLboolean {@native glIsEnabledIndexed}(GLenum target, GLuint index); </code> <br>Part of <code>GL_EXT_draw_buffers2</code>, <code>GL_EXT_direct_state_access</code>   */
  ...
  /** Entry point to C language function: <code> GLboolean {@native glIsImageHandleResidentNV}(GLuint64 handle); </code> <br>Part of <code>GL_NV_bindless_texture</code>   */
  ...
  /** Entry point to C language function: <code> GLboolean {@native glIsPathNV}(GLuint path); </code> <br>Part of <code>GL_NV_path_rendering</code>   */
  public boolean glIsPathNV(int path);

  /** Entry point to C language function: <code> GLboolean {@native glIsPointInFillPathNV}(GLuint path, GLuint mask, GLfloat x, GLfloat y); </code> <br>Part of <code>GL_NV_path_rendering</code>   */
  public boolean glIsPointInFillPathNV(int path, int mask, float x, float y);

  /** Entry point to C language function: <code> GLboolean {@native glIsPointInStrokePathNV}(GLuint path, GLfloat x, GLfloat y); </code> <br>Part of <code>GL_NV_path_rendering</code>   */
  ...
  /** Entry point to C language function: <code> GLboolean {@native glIsTextureHandleResidentNV}(GLuint64 handle); </code> <br>Part of <code>GL_NV_bindless_texture</code>   */
  ...
  /** Entry point to C language function: <code> void {@native glMakeImageHandleNonResidentNV}(GLuint64 handle); </code> <br>Part of <code>GL_NV_bindless_texture</code>   */
  public void glMakeImageHandleNonResidentNV(long handle);

  /** Entry point to C language function: <code> void {@native glMakeImageHandleResidentNV}(GLuint64 handle, GLenum access); </code> <br>Part of <code>GL_NV_bindless_texture</code>   */
  public void glMakeImageHandleResidentNV(long handle, int access);

  /** Entry point to C language function: <code> void {@native glMakeTextureHandleNonResidentNV}(GLuint64 handle); </code> <br>Part of <code>GL_NV_bindless_texture</code>   */
  public void glMakeTextureHandleNonResidentNV(long handle);

  /** Entry point to C language function: <code> void {@native glMakeTextureHandleResidentNV}(GLuint64 handle); </code> <br>Part of <code>GL_NV_bindless_texture</code>   */
  ...
  /** Entry point to C language function: <code> void *  {@native glMapNamedBufferEXT}(GLuint buffer, GLenum access); </code> <br>Part of <code>GL_EXT_direct_state_access</code>   */
  public ByteBuffer glMapNamedBufferEXT(int buffer, int access);

  /** Entry point to C language function: <code> void *  {@native glMapNamedBufferRangeEXT}(GLuint buffer, GLintptr offset, GLsizeiptr length, GLbitfield access); </code> <br>Part of <code>GL_EXT_direct_state_access</code>   */
  ...
  /** Entry point to C language function: <code> void *  {@native glMapTexture2DINTEL}(GLuint texture, GLint level, GLbitfield access, const GLint *  stride, const GLenum *  layout); </code> <br>Part of <code>GL_INTEL_map_texture</code>
  ...
  /** Entry point to C language function: <code> void {@native glMatrixIndexPointer}(GLint size, GLenum type, GLsizei stride, const GLvoid *  pointer); </code> <br>Part of <code>GL_OES_matrix_palette</code>; <code>GL_ARB_matrix_palette</code>
      @param pointer a direct or array-backed {@link java.nio.Buffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glMinmax}(GLenum target, GLenum internalformat, GLboolean sink); </code> <br>Part of <code>GL_VERSION_1_2</code>, <code>GL_ARB_imaging</code>   */
  ...
  /** Entry point to C language function: <code> void {@native glMultiTexCoord1bOES}(GLenum texture, GLbyte s); </code> <br>Part of <code>GL_OES_byte_coordinates</code>   */
  public void glMultiTexCoord1bOES(int texture, byte s);

  /** Entry point to C language function: <code> void {@native glMultiTexCoord1bvOES}(GLenum texture, const GLbyte *  coords); </code> <br>Part of <code>GL_OES_byte_coordinates</code>
  ...
  /** Entry point to C language function: <code> void {@native glMultiTexCoord1h}(GLenum target, GLhalfNV s); </code> <br>Part of <code>GL_NV_half_float</code>   */
  public void glMultiTexCoord1h(int target, short s);

  /** Entry point to C language function: <code> void {@native glMultiTexCoord1hv}(GLenum target, const GLhalfNV *  v); </code> <br>Part of <code>GL_NV_half_float</code>
      @param v a direct or array-backed {@link java.nio.ShortBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glMultiTexCoord2bOES}(GLenum texture, GLbyte s, GLbyte t); </code> <br>Part of <code>GL_OES_byte_coordinates</code>   */
  public void glMultiTexCoord2bOES(int texture, byte s, byte t);

  /** Entry point to C language function: <code> void {@native glMultiTexCoord2bvOES}(GLenum texture, const GLbyte *  coords); </code> <br>Part of <code>GL_OES_byte_coordinates</code>
      @param coords a direct or array-backed {@link java.nio.ByteBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glMultiTexCoord2h}(GLenum target, GLhalfNV s, GLhalfNV t); </code> <br>Part of <code>GL_NV_half_float</code>   */
  public void glMultiTexCoord2h(int target, short s, short t);

  /** Entry point to C language function: <code> void {@native glMultiTexCoord2hv}(GLenum target, const GLhalfNV *  v); </code> <br>Part of <code>GL_NV_half_float</code>
      @param v a direct or array-backed {@link java.nio.ShortBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glMultiTexCoord3bOES}(GLenum texture, GLbyte s, GLbyte t, GLbyte r); </code> <br>Part of <code>GL_OES_byte_coordinates</code>   */
  public void glMultiTexCoord3bOES(int texture, byte s, byte t, byte r);

  /** Entry point to C language function: <code> void {@native glMultiTexCoord3bvOES}(GLenum texture, const GLbyte *  coords); </code> <br>Part of <code>GL_OES_byte_coordinates</code>
      @param coords a direct or array-backed {@link java.nio.ByteBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glMultiTexCoord3h}(GLenum target, GLhalfNV s, GLhalfNV t, GLhalfNV r); </code> <br>Part of <code>GL_NV_half_float</code>   */
  public void glMultiTexCoord3h(int target, short s, short t, short r);

  /** Entry point to C language function: <code> void {@native glMultiTexCoord3hv}(GLenum target, const GLhalfNV *  v); </code> <br>Part of <code>GL_NV_half_float</code>
      @param v a direct or array-backed {@link java.nio.ShortBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glMultiTexCoord4bOES}(GLenum texture, GLbyte s, GLbyte t, GLbyte r, GLbyte q); </code> <br>Part of <code>GL_OES_byte_coordinates</code>   */
  public void glMultiTexCoord4bOES(int texture, byte s, byte t, byte r, byte q);

  /** Entry point to C language function: <code> void {@native glMultiTexCoord4bvOES}(GLenum texture, const GLbyte *  coords); </code> <br>Part of <code>GL_OES_byte_coordinates</code>
      @param coords a direct or array-backed {@link java.nio.ByteBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glMultiTexCoord4h}(GLenum target, GLhalfNV s, GLhalfNV t, GLhalfNV r, GLhalfNV q); </code> <br>Part of <code>GL_NV_half_float</code>   */
  public void glMultiTexCoord4h(int target, short s, short t, short r, short q);

  /** Entry point to C language function: <code> void {@native glMultiTexCoord4hv}(GLenum target, const GLhalfNV *  v); </code> <br>Part of <code>GL_NV_half_float</code>
      @param v a direct or array-backed {@link java.nio.ShortBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glMultiTexCoord4i}(GLenum target, GLint s, GLint t, GLint r, GLint q); </code> <br>Part of <code>GL_VERSION_1_3</code>   */
  ...
  /** Entry point to C language function: <code> void {@native glNormal3h}(GLhalfNV nx, GLhalfNV ny, GLhalfNV nz); </code> <br>Part of <code>GL_NV_half_float</code>   */
  public void glNormal3h(short nx, short ny, short nz);

  /** Entry point to C language function: <code> void {@native glNormal3hv}(const GLhalfNV *  v); </code> <br>Part of <code>GL_NV_half_float</code>
      @param v a direct or array-backed {@link java.nio.ShortBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glPathColorGenNV}(GLenum color, GLenum genMode, GLenum colorFormat, const GLfloat *  coeffs); </code> <br>Part of <code>GL_NV_path_rendering</code>
      @param coeffs a direct or array-backed {@link java.nio.FloatBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glPathCommandsNV}(GLuint path, GLsizei numCommands, const GLubyte *  commands, GLsizei numCoords, GLenum coordType, const GLvoid *  coords); </code> <br>Part of <code>GL_NV_path_rendering</code>
      @param commands a direct or array-backed {@link java.nio.ByteBuffer}
      @param coords a direct or array-backed {@link java.nio.Buffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glPathCoordsNV}(GLuint path, GLsizei numCoords, GLenum coordType, const GLvoid *  coords); </code> <br>Part of <code>GL_NV_path_rendering</code>
      @param coords a direct or array-backed {@link java.nio.Buffer}   */
  public void glPathCoordsNV(int path, int numCoords, int coordType, Buffer coords);

  /** Entry point to C language function: <code> void {@native glPathCoverDepthFuncNV}(GLenum func); </code> <br>Part of <code>GL_NV_path_rendering</code>   */
  public void glPathCoverDepthFuncNV(int func);

  /** Entry point to C language function: <code> void {@native glPathDashArrayNV}(GLuint path, GLsizei dashCount, const GLfloat *  dashArray); </code> <br>Part of <code>GL_NV_path_rendering</code>
      @param dashArray a direct or array-backed {@link java.nio.FloatBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glPathFogGenNV}(GLenum genMode); </code> <br>Part of <code>GL_NV_path_rendering</code>   */
  public void glPathFogGenNV(int genMode);

  /** Entry point to C language function: <code> void {@native glPathGlyphRangeNV}(GLuint firstPathName, GLenum fontTarget, const GLvoid *  fontName, GLbitfield fontStyle, GLuint firstGlyph, GLsizei numGlyphs, GLenum handleMissingGlyphs, GLuint pathParameterTemplate, GLfloat emScale); </code> <br>Part of <code>GL_NV_path_rendering</code>
      @param fontName a direct or array-backed {@link java.nio.Buffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glPathGlyphsNV}(GLuint firstPathName, GLenum fontTarget, const GLvoid *  fontName, GLbitfield fontStyle, GLsizei numGlyphs, GLenum type, const GLvoid *  charcodes, GLenum handleMissingGlyphs, GLuint pathParameterTemplate, GLfloat emScale); </code> <br>Part of <code>GL_NV_path_rendering</code>
      @param fontName a direct or array-backed {@link java.nio.Buffer}
      @param charcodes a direct or array-backed {@link java.nio.Buffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glPathParameterfNV}(GLuint path, GLenum pname, GLfloat value); </code> <br>Part of <code>GL_NV_path_rendering</code>   */
  public void glPathParameterfNV(int path, int pname, float value);

  /** Entry point to C language function: <code> void {@native glPathParameterfvNV}(GLuint path, GLenum pname, const GLfloat *  value); </code> <br>Part of <code>GL_NV_path_rendering</code>
      @param value a direct or array-backed {@link java.nio.FloatBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glPathParameteriNV}(GLuint path, GLenum pname, GLint value); </code> <br>Part of <code>GL_NV_path_rendering</code>   */
  public void glPathParameteriNV(int path, int pname, int value);

  /** Entry point to C language function: <code> void {@native glPathParameterivNV}(GLuint path, GLenum pname, const GLint *  value); </code> <br>Part of <code>GL_NV_path_rendering</code>
      @param value a direct or array-backed {@link java.nio.IntBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glPathStencilDepthOffsetNV}(GLfloat factor, GLfloat units); </code> <br>Part of <code>GL_NV_path_rendering</code>   */
  public void glPathStencilDepthOffsetNV(float factor, float units);

  /** Entry point to C language function: <code> void {@native glPathStencilFuncNV}(GLenum func, GLint ref, GLuint mask); </code> <br>Part of <code>GL_NV_path_rendering</code>   */
  public void glPathStencilFuncNV(int func, int ref, int mask);

  /** Entry point to C language function: <code> void {@native glPathStringNV}(GLuint path, GLenum format, GLsizei length, const GLvoid *  pathString); </code> <br>Part of <code>GL_NV_path_rendering</code>
      @param pathString a direct or array-backed {@link java.nio.Buffer}   */
  public void glPathStringNV(int path, int format, int length, Buffer pathString);

  /** Entry point to C language function: <code> void {@native glPathSubCommandsNV}(GLuint path, GLsizei commandStart, GLsizei commandsToDelete, GLsizei numCommands, const GLubyte *  commands, GLsizei numCoords, GLenum coordType, const GLvoid *  coords); </code> <br>Part of <code>GL_NV_path_rendering</code>
      @param commands a direct or array-backed {@link java.nio.ByteBuffer}
      @param coords a direct or array-backed {@link java.nio.Buffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glPathSubCoordsNV}(GLuint path, GLsizei coordStart, GLsizei numCoords, GLenum coordType, const GLvoid *  coords); </code> <br>Part of <code>GL_NV_path_rendering</code>
      @param coords a direct or array-backed {@link java.nio.Buffer}   */
  public void glPathSubCoordsNV(int path, int coordStart, int numCoords, int coordType, Buffer coords);

  /** Entry point to C language function: <code> void {@native glPathTexGenNV}(GLenum texCoordSet, GLenum genMode, GLint components, const GLfloat *  coeffs); </code> <br>Part of <code>GL_NV_path_rendering</code>
      @param coeffs a direct or array-backed {@link java.nio.FloatBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glPixelDataRangeNV}(GLenum target, GLsizei length, const GLvoid *  pointer); </code> <br>Part of <code>GL_NV_pixel_data_range</code>
      @param pointer a direct only {@link java.nio.Buffer}   */
  ...
  /** Entry point to C language function: <code> GLboolean {@native glPointAlongPathNV}(GLuint path, GLsizei startSegment, GLsizei numSegments, GLfloat distance, GLfloat *  x, GLfloat *  y, GLfloat *  tangentX, GLfloat *  tangentY); </code> <br>Part of <code>GL_NV_path_rendering</code>
      @param x a direct or array-backed {@link java.nio.FloatBuffer}
      @param y a direct or array-backed {@link java.nio.FloatBuffer}
      @param tangentX a direct or array-backed {@link java.nio.FloatBuffer}
      @param tangentY a direct or array-backed {@link java.nio.FloatBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glProgramBufferParametersIivNV}(GLenum target, GLuint bindingIndex, GLuint wordIndex, GLsizei count, const GLint *  params); </code> <br>Part of <code>GL_NV_parameter_buffer_object</code>
      @param params a direct or array-backed {@link java.nio.IntBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glProgramBufferParametersIuivNV}(GLenum target, GLuint bindingIndex, GLuint wordIndex, GLsizei count, const GLuint *  params); </code> <br>Part of <code>GL_NV_parameter_buffer_object</code>
      @param params a direct or array-backed {@link java.nio.IntBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glProgramBufferParametersfvNV}(GLenum target, GLuint bindingIndex, GLuint wordIndex, GLsizei count, const GLfloat *  params); </code> <br>Part of <code>GL_NV_parameter_buffer_object</code>
      @param params a direct or array-backed {@link java.nio.FloatBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glProgramUniformHandleui64NV}(GLuint program, GLint location, GLuint64 value); </code> <br>Part of <code>GL_NV_bindless_texture</code>   */
  public void glProgramUniformHandleui64NV(int program, int location, long value);

  /** Entry point to C language function: <code> void {@native glProgramUniformHandleui64vNV}(GLuint program, GLint location, GLsizei count, const GLuint64 *  values); </code> <br>Part of <code>GL_NV_bindless_texture</code>
  ...
  /** Entry point to C language function: <code> void {@native glResetHistogram}(GLenum target); </code> <br>Part of <code>GL_VERSION_1_2</code>, <code>GL_ARB_imaging</code>   */
  public void glResetHistogram(int target);

  /** Entry point to C language function: <code> void {@native glResetMinmax}(GLenum target); </code> <br>Part of <code>GL_VERSION_1_2</code>, <code>GL_ARB_imaging</code>   */
  ...
  /** Entry point to C language function: <code> void {@native glSecondaryColor3dv}(const GLdouble *  v); </code> <br>Part of <code>GL_VERSION_1_4</code>
      @param v a direct or array-backed {@link java.nio.DoubleBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glSecondaryColor3fv}(const GLfloat *  v); </code> <br>Part of <code>GL_VERSION_1_4</code>
      @param v a direct or array-backed {@link java.nio.FloatBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glSecondaryColor3h}(GLhalfNV red, GLhalfNV green, GLhalfNV blue); </code> <br>Part of <code>GL_NV_half_float</code>   */
  public void glSecondaryColor3h(short red, short green, short blue);

  /** Entry point to C language function: <code> void {@native glSecondaryColor3hv}(const GLhalfNV *  v); </code> <br>Part of <code>GL_NV_half_float</code>
      @param v a direct or array-backed {@link java.nio.ShortBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glSeparableFilter2D}(GLenum target, GLenum internalformat, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid *  row, const GLvoid *  column); </code> <br>Part of <code>GL_VERSION_1_2</code>, <code>GL_ARB_imaging</code>
      @param row a direct or array-backed {@link java.nio.Buffer}
      @param column a direct or array-backed {@link java.nio.Buffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glStencilFillPathInstancedNV}(GLsizei numPaths, GLenum pathNameType, const GLvoid *  paths, GLuint pathBase, GLenum fillMode, GLuint mask, GLenum transformType, const GLfloat *  transformValues); </code> <br>Part of <code>GL_NV_path_rendering</code>
      @param paths a direct or array-backed {@link java.nio.Buffer}
      @param transformValues a direct or array-backed {@link java.nio.FloatBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glStencilFillPathNV}(GLuint path, GLenum fillMode, GLuint mask); </code> <br>Part of <code>GL_NV_path_rendering</code>   */
  public void glStencilFillPathNV(int path, int fillMode, int mask);

  /** Entry point to C language function: <code> void {@native glStencilStrokePathInstancedNV}(GLsizei numPaths, GLenum pathNameType, const GLvoid *  paths, GLuint pathBase, GLint reference, GLuint mask, GLenum transformType, const GLfloat *  transformValues); </code> <br>Part of <code>GL_NV_path_rendering</code>
      @param paths a direct or array-backed {@link java.nio.Buffer}
      @param transformValues a direct or array-backed {@link java.nio.FloatBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glStencilStrokePathNV}(GLuint path, GLint reference, GLuint mask); </code> <br>Part of <code>GL_NV_path_rendering</code>   */
  ...
  /** Entry point to C language function: <code> void {@native glSyncTextureINTEL}(GLuint texture); </code> <br>Part of <code>GL_INTEL_map_texture</code>   */
  ...
  /** Entry point to C language function: <code> void {@native glTexCoord1bOES}(GLbyte s); </code> <br>Part of <code>GL_OES_byte_coordinates</code>   */
  public void glTexCoord1bOES(byte s);

  /** Entry point to C language function: <code> void {@native glTexCoord1bvOES}(const GLbyte *  coords); </code> <br>Part of <code>GL_OES_byte_coordinates</code>
      @param coords a direct or array-backed {@link java.nio.ByteBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glTexCoord1h}(GLhalfNV s); </code> <br>Part of <code>GL_NV_half_float</code>   */
  public void glTexCoord1h(short s);

  /** Entry point to C language function: <code> void {@native glTexCoord1hv}(const GLhalfNV *  v); </code> <br>Part of <code>GL_NV_half_float</code>
      @param v a direct or array-backed {@link java.nio.ShortBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glTexCoord2bOES}(GLbyte s, GLbyte t); </code> <br>Part of <code>GL_OES_byte_coordinates</code>   */
  public void glTexCoord2bOES(byte s, byte t);

  /** Entry point to C language function: <code> void {@native glTexCoord2bvOES}(const GLbyte *  coords); </code> <br>Part of <code>GL_OES_byte_coordinates</code>
      @param coords a direct or array-backed {@link java.nio.ByteBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glTexCoord2h}(GLhalfNV s, GLhalfNV t); </code> <br>Part of <code>GL_NV_half_float</code>   */
  public void glTexCoord2h(short s, short t);

  /** Entry point to C language function: <code> void {@native glTexCoord2hv}(const GLhalfNV *  v); </code> <br>Part of <code>GL_NV_half_float</code>
      @param v a direct or array-backed {@link java.nio.ShortBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glTexCoord3bOES}(GLbyte s, GLbyte t, GLbyte r); </code> <br>Part of <code>GL_OES_byte_coordinates</code>   */
  public void glTexCoord3bOES(byte s, byte t, byte r);

  /** Entry point to C language function: <code> void {@native glTexCoord3bvOES}(const GLbyte *  coords); </code> <br>Part of <code>GL_OES_byte_coordinates</code>
      @param coords a direct or array-backed {@link java.nio.ByteBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glTexCoord3h}(GLhalfNV s, GLhalfNV t, GLhalfNV r); </code> <br>Part of <code>GL_NV_half_float</code>   */
  public void glTexCoord3h(short s, short t, short r);

  /** Entry point to C language function: <code> void {@native glTexCoord3hv}(const GLhalfNV *  v); </code> <br>Part of <code>GL_NV_half_float</code>
      @param v a direct or array-backed {@link java.nio.ShortBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glTexCoord4bOES}(GLbyte s, GLbyte t, GLbyte r, GLbyte q); </code> <br>Part of <code>GL_OES_byte_coordinates</code>   */
  public void glTexCoord4bOES(byte s, byte t, byte r, byte q);

  /** Entry point to C language function: <code> void {@native glTexCoord4bvOES}(const GLbyte *  coords); </code> <br>Part of <code>GL_OES_byte_coordinates</code>
      @param coords a direct or array-backed {@link java.nio.ByteBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glTexCoord4h}(GLhalfNV s, GLhalfNV t, GLhalfNV r, GLhalfNV q); </code> <br>Part of <code>GL_NV_half_float</code>   */
  public void glTexCoord4h(short s, short t, short r, short q);

  /** Entry point to C language function: <code> void {@native glTexCoord4hv}(const GLhalfNV *  v); </code> <br>Part of <code>GL_NV_half_float</code>
      @param v a direct or array-backed {@link java.nio.ShortBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glTexStorageSparseAMD}(GLenum target, GLenum internalFormat, GLsizei width, GLsizei height, GLsizei depth, GLsizei layers, GLbitfield flags); </code> <br>Part of <code>GL_AMD_sparse_texture</code>   */
  ...
  /** Entry point to C language function: <code> void {@native glTextureStorageSparseAMD}(GLuint texture, GLenum target, GLenum internalFormat, GLsizei width, GLsizei height, GLsizei depth, GLsizei layers, GLbitfield flags); </code> <br>Part of <code>GL_AMD_sparse_texture</code>   */
  ...
  /** Entry point to C language function: <code> void {@native glTransformPathNV}(GLuint resultPath, GLuint srcPath, GLenum transformType, const GLfloat *  transformValues); </code> <br>Part of <code>GL_NV_path_rendering</code>
      @param transformValues a direct or array-backed {@link java.nio.FloatBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glUniformHandleui64NV}(GLint location, GLuint64 value); </code> <br>Part of <code>GL_NV_bindless_texture</code>   */
  public void glUniformHandleui64NV(int location, long value);

  /** Entry point to C language function: <code> void {@native glUniformHandleui64vNV}(GLint location, GLsizei count, const GLuint64 *  value); </code> <br>Part of <code>GL_NV_bindless_texture</code>
  ...
  /** Entry point to C language function: <code> void {@native glUnmapTexture2DINTEL}(GLuint texture, GLint level); </code> <br>Part of <code>GL_INTEL_map_texture</code>   */
  ...
  /** Entry point to C language function: <code> GLvdpauSurfaceNV {@native glVDPAURegisterVideoSurfaceNV}(const GLvoid *  vdpSurface, GLenum target, GLsizei numTextureNames, const GLuint *  textureNames); </code> <br>Part of <code>GL_NV_vdpau_interop</code>
      @param vdpSurface a direct or array-backed {@link java.nio.Buffer}
      @param textureNames a direct or array-backed {@link java.nio.IntBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glVertex2bOES}(GLbyte x); </code> <br>Part of <code>GL_OES_byte_coordinates</code>   */
  public void glVertex2bOES(byte x);

  /** Entry point to C language function: <code> void {@native glVertex2bvOES}(const GLbyte *  coords); </code> <br>Part of <code>GL_OES_byte_coordinates</code>
      @param coords a direct or array-backed {@link java.nio.ByteBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glVertex2h}(GLhalfNV x, GLhalfNV y); </code> <br>Part of <code>GL_NV_half_float</code>   */
  public void glVertex2h(short x, short y);

  /** Entry point to C language function: <code> void {@native glVertex2hv}(const GLhalfNV *  v); </code> <br>Part of <code>GL_NV_half_float</code>
      @param v a direct or array-backed {@link java.nio.ShortBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glVertex3bOES}(GLbyte x, GLbyte y); </code> <br>Part of <code>GL_OES_byte_coordinates</code>   */
  public void glVertex3bOES(byte x, byte y);

  /** Entry point to C language function: <code> void {@native glVertex3bvOES}(const GLbyte *  coords); </code> <br>Part of <code>GL_OES_byte_coordinates</code>
      @param coords a direct or array-backed {@link java.nio.ByteBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glVertex3h}(GLhalfNV x, GLhalfNV y, GLhalfNV z); </code> <br>Part of <code>GL_NV_half_float</code>   */
  public void glVertex3h(short x, short y, short z);

  /** Entry point to C language function: <code> void {@native glVertex3hv}(const GLhalfNV *  v); </code> <br>Part of <code>GL_NV_half_float</code>
      @param v a direct or array-backed {@link java.nio.ShortBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glVertex4bOES}(GLbyte x, GLbyte y, GLbyte z); </code> <br>Part of <code>GL_OES_byte_coordinates</code>   */
  public void glVertex4bOES(byte x, byte y, byte z);

  /** Entry point to C language function: <code> void {@native glVertex4bvOES}(const GLbyte *  coords); </code> <br>Part of <code>GL_OES_byte_coordinates</code>
      @param coords a direct or array-backed {@link java.nio.ByteBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glVertex4h}(GLhalfNV x, GLhalfNV y, GLhalfNV z, GLhalfNV w); </code> <br>Part of <code>GL_NV_half_float</code>   */
  public void glVertex4h(short x, short y, short z, short w);

  /** Entry point to C language function: <code> void {@native glVertex4hv}(const GLhalfNV *  v); </code> <br>Part of <code>GL_NV_half_float</code>
      @param v a direct or array-backed {@link java.nio.ShortBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glVertexArrayColorOffsetEXT}(GLuint vaobj, GLuint buffer, GLint size, GLenum type, GLsizei stride, GLintptr offset); </code> <br>Part of <code>GL_EXT_direct_state_access</code>   */
  public void glVertexArrayColorOffsetEXT(int vaobj, int buffer, int size, int type, int stride, long offset);

  /** Entry point to C language function: <code> void {@native glVertexArrayEdgeFlagOffsetEXT}(GLuint vaobj, GLuint buffer, GLsizei stride, GLintptr offset); </code> <br>Part of <code>GL_EXT_direct_state_access</code>   */
  public void glVertexArrayEdgeFlagOffsetEXT(int vaobj, int buffer, int stride, long offset);

  /** Entry point to C language function: <code> void {@native glVertexArrayFogCoordOffsetEXT}(GLuint vaobj, GLuint buffer, GLenum type, GLsizei stride, GLintptr offset); </code> <br>Part of <code>GL_EXT_direct_state_access</code>   */
  public void glVertexArrayFogCoordOffsetEXT(int vaobj, int buffer, int type, int stride, long offset);

  /** Entry point to C language function: <code> void {@native glVertexArrayIndexOffsetEXT}(GLuint vaobj, GLuint buffer, GLenum type, GLsizei stride, GLintptr offset); </code> <br>Part of <code>GL_EXT_direct_state_access</code>   */
  public void glVertexArrayIndexOffsetEXT(int vaobj, int buffer, int type, int stride, long offset);

  /** Entry point to C language function: <code> void {@native glVertexArrayMultiTexCoordOffsetEXT}(GLuint vaobj, GLuint buffer, GLenum texunit, GLint size, GLenum type, GLsizei stride, GLintptr offset); </code> <br>Part of <code>GL_EXT_direct_state_access</code>   */
  ...
  /** Entry point to C language function: <code> void {@native glVertexArrayNormalOffsetEXT}(GLuint vaobj, GLuint buffer, GLenum type, GLsizei stride, GLintptr offset); </code> <br>Part of <code>GL_EXT_direct_state_access</code>   */
  ...
  /** Entry point to C language function: <code> void {@native glVertexArraySecondaryColorOffsetEXT}(GLuint vaobj, GLuint buffer, GLint size, GLenum type, GLsizei stride, GLintptr offset); </code> <br>Part of <code>GL_EXT_direct_state_access</code>   */
  public void glVertexArraySecondaryColorOffsetEXT(int vaobj, int buffer, int size, int type, int stride, long offset);

  /** Entry point to C language function: <code> void {@native glVertexArrayTexCoordOffsetEXT}(GLuint vaobj, GLuint buffer, GLint size, GLenum type, GLsizei stride, GLintptr offset); </code> <br>Part of <code>GL_EXT_direct_state_access</code>   */
  public void glVertexArrayTexCoordOffsetEXT(int vaobj, int buffer, int size, int type, int stride, long offset);

  /** Entry point to C language function: <code> void {@native glVertexArrayVertexAttribIOffsetEXT}(GLuint vaobj, GLuint buffer, GLuint index, GLint size, GLenum type, GLsizei stride, GLintptr offset); </code> <br>Part of <code>GL_EXT_direct_state_access</code>   */
  public void glVertexArrayVertexAttribIOffsetEXT(int vaobj, int buffer, int index, int size, int type, int stride, long offset);

  /** Entry point to C language function: <code> void {@native glVertexArrayVertexAttribOffsetEXT}(GLuint vaobj, GLuint buffer, GLuint index, GLint size, GLenum type, GLboolean normalized, GLsizei stride, GLintptr offset); </code> <br>Part of <code>GL_EXT_direct_state_access</code>   */
  ...
  /** Entry point to C language function: <code> void {@native glVertexArrayVertexOffsetEXT}(GLuint vaobj, GLuint buffer, GLint size, GLenum type, GLsizei stride, GLintptr offset); </code> <br>Part of <code>GL_EXT_direct_state_access</code>   */
  ...
  /** Entry point to C language function: <code> void {@native glVertexAttrib1h}(GLuint index, GLhalfNV x); </code> <br>Part of <code>GL_NV_half_float</code>   */
  public void glVertexAttrib1h(int index, short x);

  /** Entry point to C language function: <code> void {@native glVertexAttrib1hv}(GLuint index, const GLhalfNV *  v); </code> <br>Part of <code>GL_NV_half_float</code>
      @param v a direct or array-backed {@link java.nio.ShortBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glVertexAttrib2h}(GLuint index, GLhalfNV x, GLhalfNV y); </code> <br>Part of <code>GL_NV_half_float</code>   */
  public void glVertexAttrib2h(int index, short x, short y);

  /** Entry point to C language function: <code> void {@native glVertexAttrib2hv}(GLuint index, const GLhalfNV *  v); </code> <br>Part of <code>GL_NV_half_float</code>
      @param v a direct or array-backed {@link java.nio.ShortBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glVertexAttrib3h}(GLuint index, GLhalfNV x, GLhalfNV y, GLhalfNV z); </code> <br>Part of <code>GL_NV_half_float</code>   */
  public void glVertexAttrib3h(int index, short x, short y, short z);

  /** Entry point to C language function: <code> void {@native glVertexAttrib3hv}(GLuint index, const GLhalfNV *  v); </code> <br>Part of <code>GL_NV_half_float</code>
      @param v a direct or array-backed {@link java.nio.ShortBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glVertexAttrib4h}(GLuint index, GLhalfNV x, GLhalfNV y, GLhalfNV z, GLhalfNV w); </code> <br>Part of <code>GL_NV_half_float</code>   */
  public void glVertexAttrib4h(int index, short x, short y, short z, short w);

  /** Entry point to C language function: <code> void {@native glVertexAttrib4hv}(GLuint index, const GLhalfNV *  v); </code> <br>Part of <code>GL_NV_half_float</code>
      @param v a direct or array-backed {@link java.nio.ShortBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glVertexAttribParameteriAMD}(GLuint index, GLenum pname, GLint param); </code> <br>Part of <code>GL_AMD_interleaved_elements</code>   */
  ...
  /** Entry point to C language function: <code> void {@native glVertexAttribs1hv}(GLuint index, GLsizei n, const GLhalfNV *  v); </code> <br>Part of <code>GL_NV_half_float</code>
      @param v a direct or array-backed {@link java.nio.ShortBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glVertexAttribs2hv}(GLuint index, GLsizei n, const GLhalfNV *  v); </code> <br>Part of <code>GL_NV_half_float</code>
      @param v a direct or array-backed {@link java.nio.ShortBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glVertexAttribs3hv}(GLuint index, GLsizei n, const GLhalfNV *  v); </code> <br>Part of <code>GL_NV_half_float</code>
      @param v a direct or array-backed {@link java.nio.ShortBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glVertexAttribs4hv}(GLuint index, GLsizei n, const GLhalfNV *  v); </code> <br>Part of <code>GL_NV_half_float</code>
      @param v a direct or array-backed {@link java.nio.ShortBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glVertexWeightPointerEXT}(GLint size, GLenum type, GLsizei stride, const GLvoid *  pointer); </code> <br>Part of <code>GL_EXT_vertex_weighting</code>
      @param pointer a direct only {@link java.nio.Buffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glVertexWeighth}(GLhalfNV weight); </code> <br>Part of <code>GL_NV_half_float</code>   */
  public void glVertexWeighth(short weight);

  /** Entry point to C language function: <code> void {@native glVertexWeighthv}(const GLhalfNV *  weight); </code> <br>Part of <code>GL_NV_half_float</code>
  ...
  /** Entry point to C language function: <code> void {@native glWeightPathsNV}(GLuint resultPath, GLsizei numPaths, const GLuint *  paths, const GLfloat *  weights); </code> <br>Part of <code>GL_NV_path_rendering</code>
      @param paths a direct or array-backed {@link java.nio.IntBuffer}
  ...
  /** Entry point to C language function: <code> void {@native glWeightPointer}(GLint size, GLenum type, GLsizei stride, const GLvoid *  pointer); </code> <br>Part of <code>GL_OES_matrix_palette</code>; <code>GL_ARB_vertex_blend</code>
      @param pointer a direct or array-backed {@link java.nio.Buffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glWindowPos2dv}(const GLdouble *  v); </code> <br>Part of <code>GL_VERSION_1_4</code>
      @param v a direct or array-backed {@link java.nio.DoubleBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glWindowPos2fv}(const GLfloat *  v); </code> <br>Part of <code>GL_VERSION_1_4</code>
      @param v a direct or array-backed {@link java.nio.FloatBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glWindowPos3d}(GLdouble x, GLdouble y, GLdouble z); </code> <br>Part of <code>GL_VERSION_1_4</code>   */
  public void glWindowPos3d(double x, double y, double z);

  /** Entry point to C language function: <code> void {@native glWindowPos3dv}(const GLdouble *  v); </code> <br>Part of <code>GL_VERSION_1_4</code>
      @param v a direct or array-backed {@link java.nio.DoubleBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glWindowPos3f}(GLfloat x, GLfloat y, GLfloat z); </code> <br>Part of <code>GL_VERSION_1_4</code>   */
  public void glWindowPos3f(float x, float y, float z);

  /** Entry point to C language function: <code> void {@native glWindowPos3fv}(const GLfloat *  v); </code> <br>Part of <code>GL_VERSION_1_4</code>
      @param v a direct or array-backed {@link java.nio.FloatBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glWindowPos3i}(GLint x, GLint y, GLint z); </code> <br>Part of <code>GL_VERSION_1_4</code>   */
  ...
  /** Entry point to C language function: <code> void {@native glWindowPos3s}(GLshort x, GLshort y, GLshort z); </code> <br>Part of <code>GL_VERSION_1_4</code>   */
