/* !---- DO NOT EDIT: This file autogenerated by com/jogamp/gluegen/opengl/GLEmitter.java on Tue Mar 11 04:19:58 CET 2014 ----! */
...
public class GLUgl2 extends GLU{
  /** Entry point to C language function: <code> GLint {@native gluBuild1DMipmapLevelsC}(GLenum target, GLint internalFormat, GLsizei width, GLenum format, GLenum type, GLint level, GLint base, GLint max, const void *  data); </code> <br>Part of <code>GLU_VERSION_1_X</code>
      @param data a direct or array-backed {@link java.nio.Buffer}   */
  public int gluBuild1DMipmapLevelsC(int target, int internalFormat, int width, int format, int type, int level, int base, int max, Buffer data)  {

    final boolean data_is_direct = Buffers.isDirect(data);
    final long __addr_ = getGLUProcAddressTable()._addressof_gluBuild1DMipmapLevelsC;
    if (__addr_ == 0) {
      throw new GLException(String.format("Method \"%s\" not available", "gluBuild1DMipmapLevelsC"));
    }
  ...
  /** Entry point to C language function: <code> GLint {@native gluBuild1DMipmapsC}(GLenum target, GLint internalFormat, GLsizei width, GLenum format, GLenum type, const void *  data); </code> <br>Part of <code>GLU_VERSION_1_X</code>
      @param data a direct or array-backed {@link java.nio.Buffer}   */
  public int gluBuild1DMipmapsC(int target, int internalFormat, int width, int format, int type, Buffer data)  {

    final boolean data_is_direct = Buffers.isDirect(data);
    final long __addr_ = getGLUProcAddressTable()._addressof_gluBuild1DMipmapsC;
    if (__addr_ == 0) {
      throw new GLException(String.format("Method \"%s\" not available", "gluBuild1DMipmapsC"));
    }
  ...
  /** Entry point to C language function: <code> GLint {@native gluBuild2DMipmapLevelsC}(GLenum target, GLint internalFormat, GLsizei width, GLsizei height, GLenum format, GLenum type, GLint level, GLint base, GLint max, const void *  data); </code> <br>Part of <code>GLU_VERSION_1_X</code>
      @param data a direct or array-backed {@link java.nio.Buffer}   */
  public int gluBuild2DMipmapLevelsC(int target, int internalFormat, int width, int height, int format, int type, int level, int base, int max, Buffer data)  {

    final boolean data_is_direct = Buffers.isDirect(data);
    final long __addr_ = getGLUProcAddressTable()._addressof_gluBuild2DMipmapLevelsC;
    if (__addr_ == 0) {
      throw new GLException(String.format("Method \"%s\" not available", "gluBuild2DMipmapLevelsC"));
    }
  ...
  /** Entry point to C language function: <code> GLint {@native gluBuild3DMipmapLevelsC}(GLenum target, GLint internalFormat, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, GLint level, GLint base, GLint max, const void *  data); </code> <br>Part of <code>GLU_VERSION_1_X</code>
      @param data a direct or array-backed {@link java.nio.Buffer}   */
  public int gluBuild3DMipmapLevelsC(int target, int internalFormat, int width, int height, int depth, int format, int type, int level, int base, int max, Buffer data)  {

    final boolean data_is_direct = Buffers.isDirect(data);
    final long __addr_ = getGLUProcAddressTable()._addressof_gluBuild3DMipmapLevelsC;
    if (__addr_ == 0) {
      throw new GLException(String.format("Method \"%s\" not available", "gluBuild3DMipmapLevelsC"));
    }
  ...
  /** Entry point to C language function: <code> GLint {@native gluBuild3DMipmapsC}(GLenum target, GLint internalFormat, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const void *  data); </code> <br>Part of <code>GLU_VERSION_1_X</code>
      @param data a direct or array-backed {@link java.nio.Buffer}   */
  public int gluBuild3DMipmapsC(int target, int internalFormat, int width, int height, int depth, int format, int type, Buffer data)  {

    final boolean data_is_direct = Buffers.isDirect(data);
    final long __addr_ = getGLUProcAddressTable()._addressof_gluBuild3DMipmapsC;
    if (__addr_ == 0) {
      throw new GLException(String.format("Method \"%s\" not available", "gluBuild3DMipmapsC"));
    }
  ...
  /** Entry point to C language function: <code> GLint {@native gluScaleImageC}(GLenum format, GLsizei wIn, GLsizei hIn, GLenum typeIn, const void *  dataIn, GLsizei wOut, GLsizei hOut, GLenum typeOut, GLvoid *  dataOut); </code> <br>Part of <code>GLU_VERSION_1_X</code>
      @param dataIn a direct or array-backed {@link java.nio.Buffer}
      @param dataOut a direct or array-backed {@link java.nio.Buffer}   */
  public int gluScaleImageC(int format, int wIn, int hIn, int typeIn, Buffer dataIn, int wOut, int hOut, int typeOut, Buffer dataOut)  {

    final boolean dataIn_is_direct = Buffers.isDirect(dataIn);
    final boolean dataOut_is_direct = Buffers.isDirect(dataOut);
    final long __addr_ = getGLUProcAddressTable()._addressof_gluScaleImageC;
    if (__addr_ == 0) {
      throw new GLException(String.format("Method \"%s\" not available", "gluScaleImageC"));
    }
