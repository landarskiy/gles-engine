...
public class GLES1Impl implements GLBase, GL, GL2ES1, GLES1{
  ...
  /** Entry point to C language function: <code> void {@native glClipPlanefIMG}(GLenum, const GLfloat * ); </code> <br>Part of <code>GL_IMG_user_clip_plane</code>
  ...
  /** Entry point to C language function: <code> void {@native glClipPlanexIMG}(GLenum, const GLfixed * ); </code> <br>Part of <code>GL_IMG_user_clip_plane</code>
  ...
  /** Entry point to C language function: <code> void {@native glColorPointer}(GLint size, GLenum type, GLsizei stride, const GLvoid *  pointer); </code> <br>Part of <code>GL_VERSION_ES_CL_CM</code>, <code>GL_VERSION_1_1</code>
  ...
  /** Entry point to C language function: <code> void {@native glCurrentPaletteMatrix}(GLuint matrixpaletteindex); </code> <br>Part of <code>GL_ARB_matrix_palette</code>; <code>GL_OES_matrix_palette</code>   */
  public void glCurrentPaletteMatrix(int matrixpaletteindex)  {
    ...
    if (__addr_ == 0) {
      throw new GLException(String.format("Method \"%s\" not available", "glCurrentPaletteMatrix"));
    }
  ...
  /** Entry point to C language function: <code> void {@native glDisableClientState}(GLenum array); </code> <br>Part of <code>GL_VERSION_ES_CL_CM</code>, <code>GL_VERSION_1_1</code>, <code>GL_NV_vertex_buffer_unified_memory</code>   */
  ...
  /** Entry point to C language function: <code> void {@native glEnableClientState}(GLenum array); </code> <br>Part of <code>GL_VERSION_ES_CL_CM</code>, <code>GL_VERSION_1_1</code>, <code>GL_NV_vertex_buffer_unified_memory</code>   */
  ...
  /** Entry point to C language function: <code> void {@native glFrustumf}(GLfloat left, GLfloat right, GLfloat bottom, GLfloat top, GLfloat zNear, GLfloat zFar); </code> <br>Part of <code>GL_VERSION_ES_CM</code>; <code>GL_OES_single_precision</code>   */
  ...
  /** Entry point to C language function: <code> void {@native glGetClipPlanef}(GLenum pname, GLfloat *  equation); </code> <br>Part of <code>GL_VERSION_ES_CM</code>; <code>GL_OES_single_precision</code>
      @param equation a direct or array-backed {@link java.nio.FloatBuffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glMatrixIndexPointer}(GLint size, GLenum type, GLsizei stride, const GLvoid *  pointer); </code> <br>Part of <code>GL_ARB_matrix_palette</code>; <code>GL_OES_matrix_palette</code>
  ...
  public void glMatrixIndexPointer(int size, int type, int stride, Buffer pointer)  {
    ...
    if (__addr_ == 0) {
      throw new GLException(String.format("Method \"%s\" not available", "glMatrixIndexPointer"));
    }
  ...
  /** Entry point to C language function: <code> void {@native glNormalPointer}(GLenum type, GLsizei stride, const GLvoid *  pointer); </code> <br>Part of <code>GL_VERSION_ES_CL_CM</code>, <code>GL_VERSION_1_1</code>
      @param pointer a direct only {@link java.nio.Buffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glOrthof}(GLfloat left, GLfloat right, GLfloat bottom, GLfloat top, GLfloat zNear, GLfloat zFar); </code> <br>Part of <code>GL_VERSION_ES_CM</code>; <code>GL_OES_single_precision</code>   */
  ...
  /** Entry point to C language function: <code> void {@native glTexCoordPointer}(GLint size, GLenum type, GLsizei stride, const GLvoid *  pointer); </code> <br>Part of <code>GL_VERSION_ES_CL_CM</code>, <code>GL_VERSION_1_1</code>
      @param pointer a direct only {@link java.nio.Buffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glVertexPointer}(GLint size, GLenum type, GLsizei stride, const GLvoid *  pointer); </code> <br>Part of <code>GL_VERSION_ES_CL_CM</code>, <code>GL_VERSION_1_1</code>
      @param pointer a direct only {@link java.nio.Buffer}   */
  ...
  /** Entry point to C language function: <code> void {@native glWeightPointer}(GLint size, GLenum type, GLsizei stride, const GLvoid *  pointer); </code> <br>Part of <code>GL_ARB_vertex_blend</code>; <code>GL_OES_matrix_palette</code>
      @param pointer a direct or array-backed {@link java.nio.Buffer}   */
  public void glWeightPointer(int size, int type, int stride, Buffer pointer)  {
    ...
    if (__addr_ == 0) {
      throw new GLException(String.format("Method \"%s\" not available", "glWeightPointer"));
    }
