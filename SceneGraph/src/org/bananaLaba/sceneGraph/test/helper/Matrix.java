...
public class Matrix {
     ...
     */
    public static void multiplyMM(final float[] result, final int resultOffset,
            final float[] lhs, final int lhsOffset, final float[] rhs, final int rhsOffset) {
    }
     ...
     */
    public static void transposeM(final float[] mTrans, final int mTransOffset, final float[] m,
            final int mOffset) {
        for (int i = 0; i < 4; i++) {
     ...
     */
    public static boolean invertM(final float[] mInv, final int mInvOffset, final float[] m,
            final int mOffset) {
     ...
     * @param far
     */
    public static void orthoM(final float[] m, final int mOffset,
        final float left, final float right, final float bottom, final float top,
     ...
     * @param far
     */
    public static void frustumM(final float[] m, final int offset,
            final float left, final float right, final float bottom, final float top,
            final float near, final float far) {
        if (left == right) {
            throw new IllegalArgumentException("left == right");
     ...
     */
    public static void scaleM(final float[] sm, final int smOffset,
            final float[] m, final int mOffset,
     ...
     * @param z scale factor z
     */
    public static void scaleM(final float[] m, final int mOffset,
            final float x, final float y, final float z) {
        for (int i=0 ; i<4 ; i++) {
            int mi = mOffset + i;
            m[     mi] *= x;
     ...
     */
    public static void translateM(final float[] tm, final int tmOffset,
            final float[] m, final int mOffset,
            final float x, final float y, final float z) {
        for (int i=0 ; i<12 ; i++) {
     ...
     */
    public static void rotateM(final float[] rm, final int rmOffset,
            final float[] m, final int mOffset,
            final float a, final float x, final float y, final float z) {
     ...
     * @param z Z axis component
     */
    public static void rotateM(final float[] m, final int mOffset,
            final float a, final float x, final float y, final float z) {
        synchronized(Matrix.sTemp) {
            Matrix.setRotateM(Matrix.sTemp, 0, a, x, y, z);
     ...
     */
    public static void setRotateEulerM(final float[] rm, final int rmOffset,
     ...
     */
    public static void setLookAtM(final float[] rm, final int rmOffset,
            final float eyeX, final float eyeY, final float eyeZ,
            final float centerX, final float centerY, final float centerZ, final float upX, final float upY,
            final float upZ) {
